...
UPDATE "public"."lyrics_dev" SET "sounds_id" = '4', "seq" = '1', "section_name" = '1番のイントロ', "lyric" = 'こ、個性　こーこーせい', "occurrence" = NULL, "lyric_col" = NULL, "col_space" = NULL, "is_active" = 'True' WHERE "id" = '3224';
UPDATE "public"."lyrics_dev" SET "sounds_id" = '4', "seq" = '2', "section_name" = '1番のイントロ', "lyric" = '同じ制服着ても', "occurrence" = '{1}', "lyric_col" = NULL, "col_space" = NULL, "is_active" = 'True' WHERE "id" = '3225';
UPDATE "public"."lyrics_dev" SET "sounds_id" = '4', "seq" = '3', "section_name" = '1番のイントロ', "lyric" = 'こ、個性　こーこーせい', "occurrence" = NULL, "lyric_col" = NULL, "col_space" = NULL, "is_active" = 'True' WHERE "id" = '3226';
UPDATE "public"."lyrics_dev" SET "sounds_id" = '4', "seq" = '4', "section_name" = '1番のイントロ', "lyric" = '同じ授業受けても', "occurrence" = NULL, "lyric_col" = NULL, "col_space" = NULL, "is_active" = 'True' WHERE "id" = '3227';
UPDATE "public"."lyrics_dev" SET "sounds_id" = '4', "seq" = '5', "section_name" = '1番のイントロ', "lyric" = 'こ、個性　こーこーせい', "occurrence" = NULL, "lyric_col" = NULL, "col_space" = NULL, "is_active" = 'True' WHERE "id" = '3228';
UPDATE "public"."lyrics_dev" SET "sounds_id" = '4', "seq" = '6', "section_name" = '1番のイントロ', "lyric" = '同じ頃生まれても', "occurrence" = NULL, "lyric_col" = NULL, "col_space" = NULL, "is_active" = 'True' WHERE "id" = '3229';
UPDATE "public"."lyrics_dev" SET "sounds_id" = '4', "seq" = '7', "section_name" = '1番のイントロ', "lyric" = 'こ、個性　こーこーせい', "occurrence" = NULL, "lyric_col" = NULL, "col_space" = NULL, "is_active" = 'True' WHERE "id" = '3230';
UPDATE "public"."lyrics_dev" SET "sounds_id" = '4', "seq" = '8', "section_name" = '1番のイントロ', "lyric" = '同じとこ続いても', "occurrence" = NULL, "lyric_col" = NULL, "col_space" = NULL, "is_active" = 'True' WHERE "id" = '3231';
